...
private:
    ...
    void countingSortByDigit(int* arr, int n, int exp,int& comparison) {
...
public:
    ...
    // Insertion sort
    void insertionSort(int* arr, int n, int& comparison) {
    ...
    // Shaker sort
    void shakerSort(int* arr, int n, int& comparison) {
        int left = 0;
        int right = n - 1;
        int k = 0;
    ...
    // Shell sort
    void shellSort(int* arr, int n, int& comparison) {
    ...
    // Heap sort
    void heapSort(int* arr, int n, int& comparison) {
        // Build a max heap
    ...
    // Counting sort
    void countingSort(int* arr, int n, int& comparison) {
    ...
    // Radix sort
    void radixSort(int* arr, int n, int& comparison) {
    ...
    // Flash sort
    void flashSort(int* arr, int n, int& comparison) {
        if (n <= 1) {
            comparison++;
